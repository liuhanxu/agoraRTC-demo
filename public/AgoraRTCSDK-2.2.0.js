!(function(e, t) {
  'object' == typeof exports && 'object' == typeof module
    ...
    : 'function' == typeof define && define.amd
      ? define('AgoraRTC', [], t)
      : 'object' == typeof exports ? (exports.AgoraRTC = t()) : (e.AgoraRTC = t());
})(this, function() {
  return (function(e) {
    function t(n) {
    ...
    function(e, t, i) {
      'use strict';
      Object.defineProperty(t, '__esModule', { value: !0 });
      var n = ['webcs-1.agora.io', 'webcs-2.agora.io'],
        o = ['webcs-3.agora.io', 'webcs-4.agora.io'],
        r = {
          '90p_1': [160, 90],
          '120p_1': [160, 120],
          '120p_3': [120, 120],
      ...
      (t.GIT_VERSION = 'release_20180410_01-2-g5dcca91'),
        (t.VERSION = '2.2.0'),
        (t.WEBCS_DOMAIN = n),
    ...
    function(e, t, i) {
      ...
      Object.defineProperty(t, '__esModule', { value: !0 }),
        (t.random = t.safeCall = t.is32Uint = t.vsResHack = t.CSCrashRecord = t.audioLevelHelper = t.generateSessionId = t.isLiveTranscodingValid = t.checkSystemRequirements = void 0);
      var r =
        ...
        p = function() {
          var e =
            ...
            o = !1;
          return (
            c.default.debug(s.getBrowserInfo(), 'isAPISupport:' + n),
            s.isChrome() && s.getBrowserVersion() >= 58 && 'iOS' !== s.getBrowserOS() && (o = !0),
            s.isFireFox() && s.getBrowserVersion() >= 56 && (o = !0),
            s.isOpera() && s.getBrowserVersion() >= 45 && (o = !0),
            s.isSafari() && s.getBrowserVersion() >= 11 && (o = !0),
            (s.isWeChatBrowser() || s.isQQBrowser()) && 'iOS' !== s.getBrowserOS() && (o = !0),
            s.isSupportedPC() || s.isSupportedMobile() || (o = !1),
            n && o
          );
        },
        f = function() {
        ...
        v = function(e) {
          if (g)
            return (
              (this.audioContext = g),
              (this.sourceNode =
                e.otWebkitAudioSource || this.audioContext.createMediaStreamSource(e)),
        ...
        _ = {
          ...
          record: function(e) {
            if (localStorage) {
              ...
              (t = !t || t.length > 50 ? [] : t),
                t.push(e),
                localStorage.setItem('agoraCSCrashRecord', JSON.stringify(t));
            }
          },
        },
        S = function(e, t, i) {
          try {
            ...
            n.setAttribute('autoplay', ''),
              ...
              n.addEventListener('playing', function(e) {
                s.isFireFox()
                  ? n.videoWidth && (t(n.videoWidth, n.videoHeight), document.body.removeChild(n))
                  : (t(n.videoWidth, n.videoHeight), document.body.removeChild(n));
              }),
              (n.srcObject = e);
          } catch (e) {
            i(e);
        ...
        E = function(e) {
          ...
          for (var i in e)
            if (
              ('lowLatency' === i && 'boolean' != typeof e[i]) ||
              ('userConfigExtraInfo' === i && 'object' !== r(e[i])) ||
              ('transcodingUsers' === i && !b(e[i])) ||
              (!~t.indexOf(i) && 'number' != typeof e[i])
            )
              throw new Error('Param [' + i + '] is inVaild');
          return !0;
        },
        b = function(e) {
          for (var t = 0; t < e.length; t++)
            for (var i in e[t])
              if ('number' != typeof e[t][i])
                throw new Error('Param user[' + t + '] - [' + i + '] is inVaild');
          return !0;
        },
        R = function(e) {
          isNaN(e) && (e = 1e3);
      ...
      (t.checkSystemRequirements = p),
        (t.isLiveTranscodingValid = E),
        (t.generateSessionId = o),
      ...
      var n = function() {
        ...
        f = function() {
          ...
          'Chrome' === i[1] && null != (e = t.match(/(OPR(?=\/))\/?(\d+)/i)) && (i = e),
            ...
            ~t.toLowerCase().indexOf('qqbrowser') &&
              null != (e = t.match(/(qqbrowser(?=\/))\/?(\d+)/i)) &&
              (i = e),
            ~t.toLowerCase().indexOf('micromessenger') &&
              null != (e = t.match(/(micromessenger(?=\/))\/?(\d+)/i)) &&
              (i = e),
            ~t.toLowerCase().indexOf('edge') &&
              null != (e = t.match(/(edge(?=\/))\/?(\d+)/i)) &&
              (i = e),
            ~t.toLowerCase().indexOf('trident') &&
              null != (e = /\brv[ :]+(\d+)/g.exec(t) || []) &&
              (i = [null, 'IE', e[1]]);
          var n = void 0,
            o = [
          ...
          return { name: i[1], version: i[2], os: n };
        },
        m = (function() {
          var e = f();
          return function() {
      ...
      var n = function() {
          ...
          return (
            ...
            (e.removeEventListener = function(t, i) {
              var n;
              -1 !== (n = e.dispatcher.eventListeners[t].indexOf(i)) &&
                e.dispatcher.eventListeners[t].splice(n, 1);
            }),
            (e.dispatchEvent = function(t) {
              var i;
              for (i in e.dispatcher.eventListeners[t.type])
                e.dispatcher.eventListeners[t.type].hasOwnProperty(i) &&
                  'function' == typeof e.dispatcher.eventListeners[t.type][i] &&
                  e.dispatcher.eventListeners[t.type][i](t);
            }),
            (e.dispatchSocketEvent = function(t) {
              ...
              for (i in e.dispatcher.eventListeners[t.type])
                e.dispatcher.eventListeners[t.type].hasOwnProperty(i) &&
                  'function' == typeof e.dispatcher.eventListeners[t.type][i] &&
                  e.dispatcher.eventListeners[t.type][i](t.msg);
            }),
            e
          );
        },
    ...
    function(e, t, i) {
      ...
      var n = i(1),
        ...
        d = (function() {
          ...
          return (
            (e.list = {}),
            (e.url = (0, a.shouldUseHttps)()
              ? 'https://' + o.EVENT_REPORT_DOMAIN + ':6443/events/report'
              : 'http://' + o.EVENT_REPORT_DOMAIN + ':6080/events/report'),
            (e.urlBackup = (0, a.shouldUseHttps)()
              ? 'https://' + o.EVENT_REPORT_BACKUP_DOMAIN + ':6443/events/report'
              : 'http://' + o.EVENT_REPORT_BACKUP_DOMAIN + '":6080/events/report'),
            (e.sessionInit = function(t, i) {
              i.sid = t;
              var n = Object.assign(s, i);
              e.list[t] || (n.startTime = +new Date());
              ...
              delete n.appid,
                ...
                (r.lts = +new Date()),
                (r.elaps = r.lts - r.startTime),
                e.send(r);
            }),
            (e.joinChooseServer = function(t, i, n) {
              var o;
              (o = n ? Object.assign(e.list[t], i) : Object.assign({}, e.list[t], i)),
                (o.type = 'join_choose_server');
              var r = +new Date();
              (o.ev_elaps = r - o.lts),
                (o.elaps = r - o.startTime),
                (o.lts = r),
                (o.serverList = JSON.stringify(o.serverList)),
                e.send(o);
            }),
            (e.joinGateway = function(t, i) {
              ...
              n.type = 'join_gateway';
              var o = +new Date();
              (n.ev_elaps = o - n.lts), (n.elaps = o - n.startTime), (n.lts = o), e.send(n);
            }),
            ...
            (e.send = function(t) {
              try {
                (0, a.post)(
                  ...
                  null,
                  function(i) {
                    (0, a.post)(e.urlBackup, t, null, function(e) {}, { timeout: 1e4 });
                  },
                  { timeout: 1e4 }
                );
              } catch (e) {}
    ...
    function(e, t, i) {
      ...
      var o =
        ...
        g = function(e) {
          ...
          var r = (0, d.EventDispatcher)();
          if (
            ((r.params = Object.assign({}, e)),
            (r.stream = e.stream),
            (r.aux_stream = void 0),
            (r.url = e.url),
            (r.onClose = void 0),
            ...
            (r.audio = !!e.audio),
            (r.screen = !!e.screen),
            (r.screenAttributes = { width: 1920, height: 1080, maxFr: 5, minFr: 1 }),
            (r.videoSize = e.videoSize),
            (r.player = void 0),
            (r.audioLevelHelper = null),
            ...
            (r.mirror = !1 !== e.mirror),
            !(void 0 === r.videoSize || (r.videoSize instanceof Array && 4 === r.videoSize.length)))
          )
          ...
          return (
            ...
            (r.setVideoBitRate = function(t) {
              return (
                ...
                t.length > 1 &&
                ((e.attributes = e.attributes || {}),
                (e.attributes.minVideoBW = t[0]),
                (e.attributes.maxVideoBW = t[1]),
                !0)
              );
            }),
            ...
            (r.setVideoProfileCustom = function(e) {
              r.setVideoResolution(e[0]),
                r.setVideoFrameRate([e[1], e[1]]),
                r.setVideoBitRate([e[2], e[2]]);
            }),
            (r.setVideoProfileCustomPlus = function(t) {
              console.log(t),
                (e.video = n(t.width, t.height)),
                (e.attributes = e.attributes || {}),
                (e.attributes.resolution = t.width + 'x' + t.height),
                r.setVideoFrameRate([t.framerate, t.framerate]),
                r.setVideoBitRate([t.bitrate, t.bitrate]);
            }),
            ...
            (r.isVideoOn = function() {
              return (r.hasVideo() || r.hasScreen()) && r.videoEnabled;
            }),
            (r.isAudioOn = function() {
              return r.hasAudio() && r.audioEnabled;
            }),
            (r.init = function(n, a) {
              var d = (new Date().getTime(), arguments[2]);
              if ((void 0 === d && (d = 2), !0 === r.initialized))
                return void (
                  'function' == typeof a &&
                  a({ type: 'warning', msg: 'STREAM_ALREADY_INITIALIZED' })
                );
              if (!0 !== r.local)
                return void (
                  'function' == typeof a && a({ type: 'warning', msg: 'STREAM_NOT_LOCAL' })
                );
              try {
                if ((e.audio || e.video || e.screen) && void 0 === e.url) {
                  ...
                  if (e.screen)
                    ...
                    if (!t()) {
                      var m = 30,
                        g = 30;
                      void 0 !== e.attributes.minFrameRate && (m = e.attributes.minFrameRate),
                        void 0 !== e.attributes.maxFrameRate && (g = e.attributes.maxFrameRate),
                        i()
                          ? !0 === p.video
                            ? ((p.video = {
                                width: { ideal: r.videoSize[0] },
                                height: { ideal: r.videoSize[1] },
                                frameRate: { ideal: m, max: g },
                              }),
                              r.setVideoBitRate([500, 500]))
                            : 'object' === o(p.video) && (p.video.frameRate = { ideal: m, max: g })
                          : (!0 === p.audio &&
                            ...
                            !0 === p.video
                              ? ((p.video = {
                                ...
                                r.setVideoBitRate([500, 500]))
                              : 'object' === o(p.video) &&
                                (p.video.frameRate = { ideal: m, max: g }));
                    }
                  }
                  u.default.debug(p);
                  ...
                  if (
                    ((0, s.GetUserMedia)(
                      ...
                      function(t) {
                        u.default.debug('User has granted access to local media'),
                          r.dispatchEvent({ type: 'accessAllowed' }),
                          (r.stream = t),
                          (r.initialized = !0),
                          n && n(),
                          r.hasVideo() &&
                          ...
                          e.screen &&
                            (0, l.isChrome)() &&
                            r.stream &&
                            r.stream.getVideoTracks()[0] &&
                            (r.stream.getVideoTracks()[0].onended = function() {
                              r.dispatchEvent({ type: 'stopScreenSharing' });
                            });
                      },
                      function(e) {
                    ...
                    u.default.debug(_),
                      (0, s.GetUserMedia)(
                        _,
                        function(e) {
                          u.default.info('User has granted access to auxiliary local media.'),
                            r.dispatchEvent({ type: 'accessAllowed' }),
                            (r.aux_stream = e);
                        },
                        function(e) {
                  ...
                  'function' == typeof a &&
                    a({ type: 'warning', msg: 'STREAM_HAS_NO_MEDIA_ATTRIBUTES' });
              } catch (e) {
                u.default.error('Stream init:', e),
                  'function' == typeof a && a({ type: 'error', msg: e.message || e });
              }
            }),
            (r.close = function() {
              if ((u.default.debug('Close stream with id', r.streamId), void 0 !== r.stream)) {
              ...
              (r.initialized = !1),
                ...
                (r.unmuteVideo = void 0),
                (r.muteVideo = void 0),
                r.lowStream && r.lowStream.close();
            }),
            (r.enableAudio = function() {
              return (
                u.default.debug('Enable audio stream with id', r.streamId),
                !(
                  !r.hasAudio() ||
                  !r.initialized ||
                  void 0 === r.stream ||
                  !0 === r.stream.getAudioTracks()[0].enabled
                ) &&
                  (void 0 !== r.unmuteAudio && r.unmuteAudio(),
                  (r.audioEnabled = !0),
                  (r.stream.getAudioTracks()[0].enabled = !0),
                  !0)
              );
            }),
            (r.disableAudio = function() {
              return (
                u.default.debug('Disable audio stream with id', r.streamId),
                !!(
                  r.hasAudio() &&
                  r.initialized &&
                  void 0 !== r.stream &&
                  r.stream.getAudioTracks()[0].enabled
                ) &&
                  (void 0 !== r.muteAudio && r.muteAudio(),
                  (r.audioEnabled = !1),
                  (r.stream.getAudioTracks()[0].enabled = !1),
                  r.sid && m.report.audioSendingStopped(r.sid, { succ: !0, reason: 'muteAudio' }),
                  !0)
              );
            }),
            (r.enableVideo = function() {
              return (
                u.default.debug('Enable video stream with id', r.streamId),
                !(
                  !r.initialized ||
                  void 0 === r.stream ||
                  !r.stream.getVideoTracks().length ||
                  !0 === r.stream.getVideoTracks()[0].enabled
                ) &&
                  (void 0 !== r.unmuteVideo && r.unmuteVideo(),
                  (r.videoEnabled = !0),
                  (r.stream.getVideoTracks()[0].enabled = !0),
                  r.lowStream && r.lowStream.enableVideo(),
                  !0)
              );
            }),
            (r.disableVideo = function() {
              return (
                u.default.debug('Disable video stream with id', r.streamId),
                !!(
                  r.initialized &&
                  void 0 !== r.stream &&
                  r.stream.getVideoTracks().length &&
                  r.stream.getVideoTracks()[0].enabled
                ) &&
                  (void 0 !== r.muteVideo && r.muteVideo(),
                  (r.videoEnabled = !1),
                  (r.stream.getVideoTracks()[0].enabled = !1),
                  r.lowStream && r.lowStream.disableVideo(),
                  r.sid && m.report.videoSendingStopped(r.sid, { succ: !0, reason: 'muteVideo' }),
                  !0)
              );
            }),
            (r.play = function(e, t) {
              (r.showing = !1),
                !r.local || r.video || r.screen
                  ? void 0 !== e &&
                    ((r.player = new a.default({
                      id: r.getId(),
                      stream: r,
                      elementID: e,
                      options: void 0,
            ...
            (r.stop = function() {
              u.default.debug('Stop stream player with id', r.streamId),
                void 0 !== r.player && r.player.destroy();
            }),
            (r.getStats = function(e) {
              r.pc && r.pc.getStats
                ? r.pc.getStats(function(t) {
                    if (r.pc.isSubscriber) {
                      var i = (0, p.subscribeStatsFilter)(t);
                      (0, l.isFireFox)() &&
                        ((i.videoReceivedResolutionHeight = r.videoHeight + ''),
                        (i.videoReceivedResolutionWidth = r.videoWidth + '')),
                        e && e((0, p.subscribeStatsFilter)(t));
                    } else {
                      var i = (0, p.publishStatsFilter)(t);
                      ((0, l.isSafari)() || (0, l.isFireFox)()) &&
                        ((i.videoSendResolutionHeight = r.videoHeight + ''),
                        (i.videoSendResolutionWidth = r.videoWidth + '')),
                        ((0, l.isSafari)() || (0, l.isFireFox)()) &&
                          r.uplinkStats &&
                          ((i.videoSendBandwidth = r.uplinkStats.uplink_available_bandwidth + ''),
                          (i.videoSendPacketsLost = r.uplinkStats.uplink_cumulative_lost + '')),
                        e && e(i);
                    }
                  })
            ...
            (r.getAudioLevel = function() {
              return r.audioLevelHelper
                ? r.audioLevelHelper.getAudioLevel()
                : r.stream
                  ? 0 !== r.stream.getAudioTracks().length
                    ? ((r.audioLevelHelper = new f.audioLevelHelper(r.stream)),
                      r.audioLevelHelper.getAudioLevel())
                    : void u.default.warning(
                        "can't get audioLevel beacuse no audio trace in stream"
                      )
        ...
        _ = function(e, t) {
          (navigator.mediaDevices && navigator.mediaDevices.enumerateDevices) ||
            (u.default.warning('enumerateDevices() not supported.'),
    ...
    function(e, t, i) {
      ...
      var o = i(22),
        ...
        S = function(e) {
          var t = {};
          if (((e.session_id = _ += 1), 'undefined' != typeof window && window.navigator))
            ...
            g.default.error('Publish/subscribe video/audio streams not supported yet'),
              (t = (0, l.default)(e));
          return t;
        },
        h = function(e, t, i) {
          ...
          return (
            ...
            (n.selectSource = function(e, t, i) {
              ...
              n.setAttribute(
                'style',
                'position: absolute; z-index: 99999999; width: 65%; height: 70%; top:50%; left:50%; -webkit-transform:translate(-50%,-50%); transform:translate(-50%,-50%); border: #333333 1px solid; background: #ffffff; overflow: scroll;display: flex; justify-content: space-around; flex-wrap: wrap;padding: 50px 20px 5px 20px;box-shadow: 10px #333333;'
              ),
                document.body.appendChild(n),
                e.map(function(e) {
                  if (e.id) {
                    ...
                    (o.innerHTML = e.name),
                      o.setAttribute(
                        'style',
                        'display: inline-block;width: 70%;word-break: keep-all;white-space: nowrap;overflow: hidden;text-overflow: ellipsis;'
                      );
                    var r = document.createElement('div');
                    r.setAttribute('style', 'width: 100%;height: 70%');
                    var a = document.createElement('img');
                    a.setAttribute('style', 'height: 100%;'),
                      (a.src = e.thumbnail.toDataURL()),
                      (i.onclick = function() {
                        document.body.removeChild(n), t && t(e.id);
                      }),
                      r.appendChild(a),
                      i.appendChild(r),
                      i.appendChild(o),
              ...
              (o.innerHTML = 'Back'),
                o.setAttribute(
                  'style',
                  ' width: 100%; padding:10px 0; background-color: #fff; font-size: 20px; color: #333;border: none;'
                ),
                (o.onclick = function() {
                  document.body.removeChild(n), i && i('NotAllowedError');
                }),
                n.appendChild(o);
            }),
            (n.share = function(e) {
                ...
                n.selectSource(
                  ...
                  function(e) {
                    var t = n.config.attributes.width,
                      ...
                      o = n.config.attributes.maxFr,
                      r = n.config.attributes.minFr,
                      a = {
                        audio: !1,
                        video: {
                          mandatory: {
          ...
          if (
            ...
            if (n) {
              if (n.desktopCapturer) {
                h(e, t, i).share(n);
              } else i(v.ErrorCodes.ELECTRON_NOT_SUPPORT_SHARING_SCREEN);
              return;
            }
            if (
              (g.default.debug('Screen access requested'),
              null !== window.navigator.userAgent.match('Firefox'))
            ) {
              ...
              var o = {};
              void 0 != e.video.mandatory
                ? ((o.video = e.video), (o.video.mediaSource = e.mediaSource))
                : (o = { video: { mediaSource: e.mediaSource } }),
                navigator.getMedia(o, t, i);
              ...
              e.extensionId &&
                (g.default.debug('extensionId supplied, using ' + e.extensionId),
                (r = e.extensionId)),
                g.default.debug('Screen access on chrome stable, looking for extension');
              try {
                chrome.runtime.sendMessage(r, { getStream: !0 }, function(n) {
                  if (void 0 === n) {
            ...
            -1 === navigator.userAgent.indexOf('Chrome')
              ? navigator.mediaDevices
                  ...
                  .then(t)
                  .catch(i)
              : 'undefined' != typeof navigator && navigator.getMedia
                ? navigator.getMedia(e, t, i)
    ...
    function(e, t, i) {
      ...
      var n = i(1),
        ...
        r = function(e, t, i, n) {
          ...
          (r.timeout = t.timeout || o.HTTP_CONNECT_TIMEOUT),
            r.open('POST', e, !0),
      ...
      var o = i(1),
        ...
        f = function(e, t, i, n) {
          var o = new Date().getTime(),
            r = { key: t.appId, cname: t.cname, uid: t.uid };
          (0, d.post)(
            e,
            r,
            function(r) {
              var a = JSON.parse(r),
                s = a.error;
              void 0 != s
                ? (c.report.joinChooseServer(t.sid, {
                    lts: o,
                    succ: !1,
                    csAddr: e,
                    serverList: null,
            ...
            function(e, i) {
              'timeout' === e.type
                ? (c.report.joinChooseServer(t.sid, {
                  ...
                  n('Connect choose server timeout', i))
                : c.report.joinChooseServer(t.sid, {
                    lts: o,
                    succ: !1,
                    csAddr: i,
        ...
        m = function(e, t, i) {
          var n = new Date().getTime(),
            o = !1;
          u.CSCrashRecord.record(n);
          for (
            var a = function(i, r) {
                o
                  ? c.report.joinChooseServer(
                      e.sid,
                      {
                        lts: n,
                        succ: !0,
                  ...
                  : (clearTimeout(v),
                    (o = !0),
                    s.default.debug('Get gateway address:', i.gateway_addr),
                    t(i),
                    c.report.joinChooseServer(
                      e.sid,
                      {
            ...
            var g;
            (g = (0, d.shouldUseHttps)()
              ? 'https://' + p[m] + ':5668/getwebgw/jsonp'
              : 'http://' + p[m] + ':5669/getwebgw/jsonp'),
              f(g, e, a, l);
          }
          var v = setTimeout(function() {
            if (!o)
              for (var t = r.WEBCS_DOMAIN_BACKUP_LIST, i = 0; i < t.length; ++i) {
                var n;
                (n = (0, d.shouldUseHttps)()
                  ? 'https://' + t[i] + ':5668/getwebgw/jsonp'
                  : 'http://' + t[i] + ':5669/getwebgw/jsonp'),
                  f(n, e, a, l);
              }
          }, 1e3);
          setTimeout(function() {
        ...
        g = function(e, t, i) {
          var n = !1,
            ...
            r = 1;
          !(function a() {
            if (u.CSCrashRecord.shouldBlock())
              return (
                s.default.warning('CS connetion crash too many times in 10s'),
                i && i(p.default.JOIN_TOO_FREQUENT)
              );
            n ||
              m(
                e,
                ...
                function() {
                  s.default.debug('Request gateway list will be restart in ' + r + 's'),
        ...
        l = function(e) {
          ...
          if (
            ...
            (t.resize = function() {
              ...
              e.stream.screen
                ? 0.75 * i < n
                  ? ((t.video.style.width = i + 'px'),
                    (t.video.style.height = 0.75 * i + 'px'),
                    (t.video.style.top = -(0.75 * i / 2 - n / 2) + 'px'),
                    (t.video.style.left = '0px'))
                  : ((t.video.style.height = n + 'px'),
                    (t.video.style.width = 4 / 3 * n + 'px'),
                    (t.video.style.left = -(4 / 3 * n / 2 - i / 2) + 'px'),
                    (t.video.style.top = '0px'))
                : (i === t.containerWidth && n === t.containerHeight) ||
                  (0.75 * i > n
                    ? ((t.video.style.width = i + 'px'),
                      (t.video.style.height = 0.75 * i + 'px'),
                      (t.video.style.top = -(0.75 * i / 2 - n / 2) + 'px'),
            ...
            void 0 !== t.elementID
              ? (document.getElementById(t.elementID).appendChild(t.div),
                (t.container = document.getElementById(t.elementID)))
            ...
            t.video.addEventListener('playing', function(e) {
              !(function e() {
                if (t.video.videoWidth * t.video.videoHeight > 4)
                  return void c.default.debug(
                    'video dimensions:',
                    t.video.videoWidth,
                    t.video.videoHeight
                  );
            ...
            t.div.appendChild(t.video),
              ...
              (0, u.attachMediaStream)(t.video, e.stream.stream),
              (0, u.attachMediaStream)(t.audio, e.stream.stream);
          else if (
            (!e.stream.local && t.video.removeAttribute('muted'),
            t.div.appendChild(t.video),
            window.MediaStream)
          ) {
    ...
    function(e, t, i) {
      ...
      if (
        ('object' === ('undefined' == typeof window ? 'undefined' : o(window)) &&
          ...
          (r = window.navigator && window.navigator.getUserMedia)),
        (a = function(e, t) {
          e.srcObject = t;
        }),
        (s = function(e, t) {
        ...
        if (navigator.mozGetUserMedia && window.mozRTCPeerConnection) {
          if (
            (l.log('This appears to be Firefox'),
            (d = 'firefox'),
            (c = l.extractVersion(navigator.userAgent, /Firefox\/([0-9]+)\./, 1)),
            (u = 31),
                ...
                for (var i = [], n = 0; n < e.iceServers.length; n++) {
                  ...
                  if (o.hasOwnProperty('urls'))
                    for (var r = 0; r < o.urls.length; r++) {
                      var a = { url: o.urls[r] };
                      0 === o.urls[r].indexOf('turn') &&
                        ((a.username = o.username), (a.credential = o.credential)),
                        i.push(a);
                    }
            ...
            (r = function(e, t, i) {
                ...
                return (
                  Object.keys(e).forEach(function(i) {
                    if ('require' !== i && 'advanced' !== i && 'mediaSource' !== i) {
                      ...
                      if (
                        ((void 0 === n.min && void 0 === n.max && void 0 === n.exact) || t.push(i),
                        void 0 !== n.exact &&
              ...
              return (
                c < 38 &&
                  (l.log('spec: ' + JSON.stringify(e)),
                  e.audio && (e.audio = n(e.audio)),
                  e.video && (e.video = n(e.video)),
                  l.log('ff37: ' + JSON.stringify(e))),
          ...
          l.log('This appears to be Chrome'),
                  ...
                  var a = function(e) {
                    ...
                    return (
                      e.result().forEach(function(e) {
                        var i = { id: e.id, timestamp: e.timestamp, type: e.type };
            ...
            ['createOffer', 'createAnswer'].forEach(function(e) {
              ...
              webkitRTCPeerConnection.prototype[e] = function() {
                ...
                if (
                  arguments.length < 1 ||
                  (1 === arguments.length && 'object' === o(arguments[0]))
                ) {
          ...
          var f = function(e) {
            if ('object' !== (void 0 === e ? 'undefined' : o(e)) || e.mandatory || e.optional)
              return e;
            var t = {};
            return (
              Object.keys(e).forEach(function(i) {
                  ...
                  if (void 0 !== n.ideal) {
                    ...
                    'number' == typeof n.ideal
                      ? ((a[r('min', i)] = n.ideal),
                        ...
                        (a[r('max', i)] = n.ideal),
                        t.optional.push(a))
                      : ((a[r('', i)] = n.ideal), t.optional.push(a));
                  }
                  void 0 !== n.exact && 'number' != typeof n.exact
                    ? ((t.mandatory = t.mandatory || {}), (t.mandatory[r('', i)] = n.exact))
                    : ['min', 'max'].forEach(function(e) {
                        void 0 !== n[e] &&
                          ((t.mandatory = t.mandatory || {}), (t.mandatory[r(e, i)] = n[e]));
                      });
                }
              }),
          ...
          if (
            ((r = function(e, t, i) {
              return (
                e.audio && (e.audio = f(e.audio)),
                e.video && (e.video = f(e.video)),
            ...
            (a = function(e, t) {
              c >= 43
                ...
                : void 0 !== e.src
                  ...
                  : l.log('Error attaching stream to element.');
            }),
            (s = function(e, t) {
          ...
          navigator.mediaDevices && navigator.userAgent.match(/Edge\/(\d+).(\d+)$/)
            ? (l.log('This appears to be Edge'),
              (d = 'edge'),
              (c = l.extractVersion(navigator.userAgent, /Edge\/(\d+).(\d+)$/, 2)),
              (u = 12))
            : l.log('Browser does not appear to be WebRTC-capable');
      ...
      var n = i(0),
        ...
        r = function(e) {
          ...
          (t.pc_config = { iceServers: [] }),
            ...
            e.iceServers instanceof Array
              ...
              : (e.stunServerUrl &&
                  (e.stunServerUrl instanceof Array
                    ...
                    : 'string' == typeof e.stunServerUrl &&
                      '' !== e.stunServerUrl &&
                      t.pc_config.iceServers.push({ url: e.stunServerUrl })),
                e.turnServer &&
                  (e.turnServer instanceof Array
                    ...
                    : 'string' == typeof e.turnServer.url &&
                      '' !== e.turnServer.url &&
                      t.pc_config.iceServers.push({
            ...
            (t.mediaConstraints = {
              mandatory: { OfferToReceiveVideo: e.video, OfferToReceiveAudio: e.audio },
            }),
            (t.roapSessionId = 103),
            ...
            (t.peerConnection.onicecandidate = function(e) {
              e.candidate
                ...
                : (o.default.debug('PeerConnection State: ' + t.peerConnection.iceGatheringState),
          ...
          var n = function(t) {
            ...
            return (
              e.minVideoBW &&
                ...
                (t = t.replace(i[0], n)),
                o.default.debug(
                  'Set Video Bitrate - min:' + e.minVideoBW + ' max:' + e.maxVideoBW
                )),
              e.maxAudioBW &&
                ((i = t.match(/m=audio.*\r\n/)),
          ...
          return (
                ...
                'new' === t.state
                  ? 'OFFER' === o.messageType
                    ? ((i = { sdp: o.sdp, type: 'offer' }),
                      t.peerConnection.setRemoteDescription(new RTCSessionDescription(i)),
                      (t.state = 'offer-received'),
                      t.markActionNeeded())
                    : t.error(
                        'Illegal message for this state: ' + o.messageType + ' in state ' + t.state
                      )
                  : 'offer-sent' === t.state
                    ? 'ANSWER' === o.messageType
                      ? ((i = { sdp: o.sdp, type: 'answer' }),
                        (i.sdp = n(i.sdp)),
                        t.peerConnection.setRemoteDescription(new RTCSessionDescription(i)),
                        t.sendOK(),
                        (t.state = 'established'))
                      : 'pr-answer' === o.messageType
                  ...
                  t.peerConnection.createAnswer(
                    function(e) {
                      if (
                        ...
                        return void t.markActionNeeded();
                      var i = new Date();
                      o.default.debug(i.getTime() + ': Starting ICE in responder'),
                        (t.iceStarted = !0);
                    },
                    function(e) {
            ...
            (t.sendMessage = function(e, i) {
              ...
              (n.messageType = e),
                (n.sdp = i),
                'OFFER' === e
                  ? ((n.offererSessionId = t.sessionId),
                    (n.answererSessionId = t.otherSessionId),
                    (n.seq = t.sequenceNumber += 1),
                    (n.tiebreaker = Math.floor(429496723 * Math.random() + 1)))
                  : ((n.offererSessionId = t.incomingMessage.offererSessionId),
                    (n.answererSessionId = t.sessionId),
                    (n.seq = t.incomingMessage.seq)),
      ...
      var n = i(0),
        ...
        r = function(e) {
          ...
          (t.isSubscriber = e.isSubscriber),
            ...
            (t.roapSessionId = 103),
            (t.peerConnection = new i(
              { iceServers: [{ urls: ['stun:webcs.agora.io:3478'] }] },
              t.con
            )),
            (t.peerConnection.onicecandidate = function(e) {
              var i, n, r;
              (i = t.peerConnection.localDescription.sdp),
                ...
                (null === n && null === r) ||
                  void 0 !== t.ice ||
                  (o.default.debug('srflx candidate : ' + n + ' host candidate : ' + r),
            ...
            (t.getStats = function(e) {
              t.peerConnection.getStats(null, function(i) {
                ...
                Object.keys(i).forEach(function(e) {
                  var t = i[e];
                  o.push(t),
                    ('ssrc' !== t.type && 'VideoBwe' !== t.type) || ((r = t.timestamp), n.push(t));
                }),
                  n.push({ id: 'time', startTime: t.connectedTime, timestamp: r || new Date() }),
                  e(n, o);
              });
            }),
            (t.addStream = function(e) {
            ...
            (t.onstablestate = function() {
              ...
              if (t.actionNeeded) {
                if ('new' === t.state || 'established' === t.state)
                  t.peerConnection.createOffer(
                    function(e) {
                      if (((e.sdp = r(e.sdp)), e.sdp !== t.prevOffer))
                        return (
                          t.peerConnection.setLocalDescription(e),
                          (t.state = 'preparing-offer'),
                          void t.markActionNeeded()
                  ...
                  if (t.moreIceComing) return;
                  (t.prevOffer = t.peerConnection.localDescription.sdp),
                    (t.prevOffer = t.prevOffer.replace(
        ...
        r = function(e) {
          ...
          (t.isSubscriber = e.isSubscriber),
            ...
            (t.peerConnection.onicecandidate = function(i) {
              o.default.debug('PeerConnection: ', e.session_id, i),
                i.candidate
                  ? (0 === t.iceCandidateCount &&
                      (t.timeout = setTimeout(function() {
                        t.moreIceComing && ((t.moreIceComing = !1), t.markActionNeeded());
                  ...
                  : (o.default.debug('PeerConnection State: ' + t.peerConnection.iceGatheringState),
                    ...
                    t.ices >= 1 &&
                      t.moreIceComing &&
                      ((t.moreIceComing = !1), t.markActionNeeded()));
            });
          var i = function(t) {
              return e.screen && (t = t.replace('a=x-google-flag:conference\r\n', '')), t;
            },
          ...
          t.processSignalingMessage = function(e) {
            ...
            (t.incomingMessage = r),
              'new' === t.state
                ? 'OFFER' === r.messageType
                  ? ((o = { sdp: r.sdp, type: 'offer' }),
                    t.peerConnection.setRemoteDescription(new RTCSessionDescription(o)),
                    (t.state = 'offer-received'),
                    t.markActionNeeded())
                  : t.error(
                      'Illegal message for this state: ' + r.messageType + ' in state ' + t.state
                    )
                : 'offer-sent' === t.state
                  ? 'ANSWER' === r.messageType
                    ? ((o = { sdp: r.sdp, type: 'answer' }),
                      (o.sdp = i(o.sdp)),
                      (o.sdp = n(o.sdp)),
                      (o.sdp = o.sdp.replace(/a=x-google-flag:conference\r\n/g, '')),
                      t.peerConnection.setRemoteDescription(new RTCSessionDescription(o)),
                      t.sendOK(),
                      (t.state = 'established'))
                    : 'pr-answer' === r.messageType
                      ? ((o = { sdp: r.sdp, type: 'pr-answer' }),
                        t.peerConnection.setRemoteDescription(new RTCSessionDescription(o)))
                      : 'offer' === r.messageType
                        ? t.error('Not written yet')
                        : t.error(
              ...
              t.getStats(function(t) {
                t.forEach(function(e) {
                  'outbound-rtp' === e.type &&
                    'video' === e.mediaType &&
                    e.googFramesEncoded &&
                    ((e.googFrameRateSent = ((e.googFramesEncoded - u) / 3).toString()),
                    (u = e.googFramesEncoded)),
                    'inbound-rtp' === e.type &&
                      -1 != e.id.indexOf('55543') &&
                      (e.googFrameRateReceived &&
                        ((e.googFrameRateReceived = ((e.googFrameReceived - p) / 3).toString()),
                        (p = e.googFrameReceived)),
                      e.googFrameRateDecoded &&
                        ((e.googFrameRateDecoded = ((e.googFramesDecoded - l) / 3).toString()),
                        (l = e.googFramesDecoded)));
                }),
                  e(t);
              });
            }),
                  ...
                  n.forEach(function(e) {
                    i.push(e),
                      'outbound-rtp' === e.type &&
                        ...
                        (r.bytesSent = e.bytesSent ? e.bytesSent + '' : '0'),
                        (r.packetsSent = e.packetsSent ? e.packetsSent + '' : '0')),
                      'outbound-rtp' === e.type &&
                        'video' === e.mediaType &&
                        ((a.id = e.id),
                        (a.type = e.type),
                        ...
                        (a.googPlisReceived = e.pliCount ? e.pliCount + '' : '0'),
                        (a.googNacksReceived = e.nackCount ? e.nackCount + '' : '0'),
                        (a.googFirsReceived = e.firCount ? e.firCount + '' : '0'),
                        (a.googFramesEncoded = e.framesEncoded ? e.framesEncoded + '' : '0')),
                      'inbound-rtp' === e.type &&
                        -1 != e.id.indexOf('44444') &&
                        ((s.id = e.id),
                        (s.type = e.type),
                        (s.mediaType = 'audio'),
                        (s.packetsReceived = e.packetsReceived ? e.packetsReceived + '' : '0'),
                        (s.bytesReceived = e.bytesReceived ? e.bytesReceived + '' : '0'),
                        (s.packetsLost = e.packetsLost ? e.packetsLost + '' : '0'),
                        (s.packetsReceived = e.packetsReceived ? e.packetsReceived + '' : '0'),
                        (s.googJitterReceived = e.jitter ? e.jitter + '' : '0')),
                      'inbound-rtp' === e.type &&
                        -1 != e.id.indexOf('55543') &&
                        ((d.id = e.id),
                        (d.type = e.type),
                        ...
                        (d.googJitterBufferMs = e.jitter ? e.jitter + '' : '0'),
                        (d.googNacksSent = e.nackCount ? e.nackCount + '' : '0'),
                        (d.googPlisSent = e.pliCount ? e.pliCount + '' : '0'),
                        (d.googFirsSent = e.firCount ? e.firCount + '' : '0')),
                      'track' === e.type &&
                        -1 != e.id.indexOf('55543') &&
                        ((d.googFrameWidthReceived = e.frameWidth ? e.frameWidth + '' : '0'),
                        (d.googFrameHeightReceived = e.frameHeight ? e.frameHeight + '' : '0'),
                        (d.googFrameReceived = e.framesReceived ? e.framesReceived + '' : '0'),
                        (d.googFramesDecoded = e.framesDecoded ? e.framesDecoded + '' : '0')),
                      'track' === e.type &&
                        -1 != e.id.indexOf('44444') &&
                        ((s.audioOutputLevel = e.audioLevel + ''),
                        (r.audioInputLevel = e.audioLevel + '')),
                      'candidate-pair' === e.type &&
                        (0 == e.availableIncomingBitrate
                          ? (c.googAvailableSendBandwidth = e.availableOutgoingBitrate + '')
                          : (c.googAvailableReceiveBandwidth = e.availableIncomingBitrate + ''));
                  });
                  var o = [c, r, a, s, d];
                  o.push({ id: 'time', startTime: t.connectedTime, timestamp: new Date() }),
                    e(o, i);
                })
                .catch(function(e) {
                  console.error(e);
                  ...
                  t.peerConnection
                    ...
                    .then(function(i) {
                      if (
                        ...
                        return (
                          t.peerConnection.setLocalDescription(i),
                          (t.state = 'preparing-offer'),
                          void t.markActionNeeded()
                        );
                      o.default.debug('Not sending a new offer');
        ...
        r = function(e) {
          ...
          (t.isSubscriber = e.isSubscriber),
            ...
            (t.checkMLineReverseInSDP = function(e) {
              return (
                !(!~e.indexOf('m=audio') || !~e.indexOf('m=video')) &&
                e.indexOf('m=audio') > e.indexOf('m=video')
              );
            }),
              ...
              (t.incomingMessage = r),
                'new' === t.state
                  ...
                  : 'offer-sent' === t.state
                    ? 'ANSWER' === r.messageType
                      ? ((r.sdp = u(r.sdp)),
                        (r.sdp = r.sdp.replace(/ generation 0/g, '')),
                        (r.sdp = r.sdp.replace(/ udp /g, ' UDP ')),
                        (r.sdp = r.sdp.replace(
                          /a=group:BUNDLE audio video/,
                          'a=group:BUNDLE sdparta_0 sdparta_1'
                        )),
                        (r.sdp = r.sdp.replace(/a=mid:audio/, 'a=mid:sdparta_0')),
                        (r.sdp = r.sdp.replace(/a=mid:video/, 'a=mid:sdparta_1')),
                        t.isMLineReverseInSDP && (r.sdp = t.reverseMLineInSDP(r.sdp)),
            ...
            t.getStats(function(t) {
              t.forEach(function(e) {
                'inboundrtp' === e.type &&
                  'video' === e.mediaType &&
                  e.googFrameRateDecoded &&
                  ((e.googFrameRateDecoded = ((e.googFramesDecoded - c) / 3).toString()),
                  (c = e.googFramesDecoded));
              }),
                e(t);
            });
          }),
                  ...
                  Object.keys(i).forEach(function(e) {
                    ...
                    n.push(t),
                      'outboundrtp' === t.type &&
                        ...
                        (a.googPlisReceived = t.pliCount ? t.pliCount + '' : '0'),
                        (a.googNacksReceived = t.nackCount ? t.nackCount + '' : '0'),
                        (a.googFirsReceived = t.firCount ? t.firCount + '' : '0'),
                        (a.googFrameRateSent = t.framerateMean ? t.framerateMean + '' : '0')),
                      'outboundrtp' === t.type &&
                        'audio' === t.mediaType &&
                        ((r.id = t.id),
                        (r.type = t.type),
                        (r.mediaType = t.mediaType),
                        (r.bytesSent = t.bytesSent ? t.bytesSent + '' : '0'),
                        (r.packetsSent = t.packetsSent ? t.packetsSent + '' : '0')),
                      'inboundrtp' !== t.type ||
                        'audio' !== t.mediaType ||
                        t.isRemote ||
                        ((s.id = t.id),
                        ...
                        (s.bytesReceived = t.bytesReceived ? t.bytesReceived + '' : '0'),
                        (s.packetsLost = t.packetsLost ? t.packetsLost + '' : '0'),
                        (s.packetsReceived = t.packetsReceived ? t.packetsReceived + '' : '0'),
                        (s.googJitterReceived = t.jitter ? t.jitter + '' : '0')),
                      'inboundrtp' !== t.type ||
                        'video' !== t.mediaType ||
                        t.isRemote ||
                        ((d.id = t.id),
                        ...
                        (d.googFrameRateReceived = t.framerateMean ? t.framerateMean + '' : '0'),
                        (d.googFramesDecoded = t.framesDecoded ? t.framesDecoded + '' : '0'),
                        (d.packetsLost = t.packetsLost ? t.packetsLost + '' : '0'),
                        (d.packetsReceived = t.packetsReceived ? t.packetsReceived + '' : '0'),
                        (d.googJitterBufferMs = t.jitter ? t.jitter + '' : '0'),
                        (d.googNacksSent = t.nackCount ? t.nackCount + '' : '0'),
                        (d.googPlisSent = t.pliCount ? t.pliCount + '' : '0'),
                        (d.googFirsSent = t.firCount ? t.firCount + '' : '0')),
                      -1 !== t.id.indexOf('outbound_rtcp_video') &&
                        (a.packetsLost = t.packetsLost ? t.packetsLost + '' : '0');
                  });
                  var o = [a, r, s, d];
                  o.push({ id: 'time', startTime: t.connectedTime, timestamp: new Date() }),
                    e(o, n);
          ...
          return (
            e.forEach(function(e) {
              'VideoBwe' === e.type
                ...
                : -1 !== e.id.indexOf('send') ||
                  -1 !== e.id.indexOf('outbound_rtp') ||
                  -1 !== e.id.indexOf('OutboundRTP')
                  ? 'audio' === e.mediaType
                    ? ((t.audioSendBytes = e.bytesSent),
                      (t.audioSendPackets = e.packetsSent),
                      (t.audioCodecName = e.googCodecName))
                  ...
                  : 'time' === e.id && ((t.timestamp = e.timestamp), (t.startTime = e.startTime));
            }),
            t.timestamp instanceof Date &&
              t.startTime instanceof Date &&
              (t.duration = Math.floor((t.timestamp.getTime() - t.startTime.getTime()) / 1e3) + ''),
            t
          );
        },
        o = function(e) {
          ...
          return (
            e.forEach(function(e) {
              'VideoBwe' === e.type
                ...
                : -1 !== e.id.indexOf('recv') ||
                  -1 !== e.id.indexOf('inbound_rtp') ||
                  -1 !== e.id.indexOf('InboundRTP')
                  ? 'audio' === e.mediaType
                    ? ((t.audioReceiveBytes = e.bytesReceived),
                      (t.audioReceivePackets = e.packetsReceived),
                      (t.audioReceivePacketsLost = e.packetsLost))
      ...
      var o = i(29),
        ...
        h = function(e) {
          ...
          return (
            ...
            (t._getVideoCameraIdByLabel = function(e, t, i) {
              (0, g.getDevices)(function(n) {
                ...
                return i && i(c.default.NOT_FIND_DEVICE_BY_LABEL);
              }, i);
            }),
            (t.init = function(t, i, n) {
              if ('string' != typeof t) throw new Error('Param appId should be string');
              s.default.info('Initializing AgoraRTC client'),
                (e.appId = t),
              ...
              return 'iOS' === (0, f.getBrowserOS)()
                ...
                : (0, f.isWeChatBrowser)()
                  ? (p.report.streamSwitch(e.sessionId, {
                    ...
                    n && n(c.default.WECHAT_NOT_SUPPORT))
                  : (p.report.streamSwitch(e.sessionId, {
                      lts: new Date().getTime(),
                      isdual: !0,
                      succ: !0,
                    ...
                    (t.isDualStream = !0),
                    void (0 === t.highStreamState
                      ? t._publishLowStream(i, function(e) {
                          s.default.warning(e), n && n(c.default.ENABLE_DUALSTREAM_FAILED);
                        })
                      : 1 === t.highStreamState
                        ? n && n(c.default.STILL_ON_PUBLISHING)
                        : i && i()));
            }),
            (t.disableDualStream = function(i, n) {
              p.report.streamSwitch(e.sessionId, {
                ...
                (t.isDualStream = !1),
                0 === t.highStreamState
                  ? t._unpublishLowStream(i, function(e) {
                      s.default.warning(e), n && n(c.default.DISABLE_DUALSTREAM_FAILED);
                    })
                  : 1 === t.highStreamState ? n && n(c.default.STILL_ON_PUBLISHING) : i && i();
            }),
            (t._createLowStream = function(e, i) {
              if (!t.highStream || !t.highStream.stream)
                return void (i && i(c.default.HIGH_STREAM_NOT_VIDEO_TRACE));
              var n = Object.assign({}, t.highStream.params);
              if (((n.streamID += 1), (n.audio = !1), !n.video))
                return void (i && i(c.default.HIGH_STREAM_NOT_VIDEO_TRACE));
              var o = t.highStream.stream.getVideoTracks()[0];
              if (!o) return void (i && i(c.default.HIGH_STREAM_NOT_VIDEO_TRACE));
              t._getVideoCameraIdByLabel(
                ...
                function(r) {
                  ...
                  if (((a.streamId = t.highStream.getId() + 1), t.lowStreamParameter)) {
                    ...
                    if (!s.width || !s.height) {
                      var d = (0, m.simMap)(t.highStream.profile),
                        c = S.SUPPORT_RESOLUTION_LIST[d[0]];
                      (s.width = c[0]), (s.height = c[1]);
                    }
                    if (
                      ((s.framerate = s.framerate || 5),
                      (s.bitrate = s.bitrate || 50),
                      (0, f.isSafari)())
                    ) {
            ...
            (t._getLowStream = function(e, i) {
              t.lowStream
                ? e(t.lowStream)
                : t._createLowStream(function(i) {
                    (t.lowStream = i), e(t.lowStream);
                  }, i);
            }),
            (t._publishLowStream = function(e, i) {
              return 2 !== t.lowStreamState
                ? i && i(c.default.LOW_STREAM_ALREADY_PUBLISHED)
                : t.highStream && t.highStream.hasScreen()
                  ? i && i(c.default.SHARING_SCREEN_NOT_SUPPORT)
            ...
            (t._unpublishLowStream = function(e, i) {
              if (0 !== t.lowStreamState) return i && i(c.default.LOW_STREAM_NOT_YET_PUBLISHED);
              t.lowStream &&
            ...
            (t.join = function(i, n, o, r, a) {
              if (i && 'string' != typeof i)
                return (
                  s.default.warning('Param channelKey should be string'),
                  a && a(c.default.INVALID_PARAMETER)
                );
              if ('string' != typeof n)
                return (
                  s.default.warning('Param channel should be string'),
                  a && a(c.default.INVALID_PARAMETER)
                );
              if (o && ('number' != typeof o || !(0, u.is32Uint)(o)))
                return (
                  s.default.warning('Param uid should be number'),
                  a && a(c.default.INVALID_PARAMETER)
                );
              (t.highStream = null),
                (t.lowStream = null),
                ...
                (t.highStreamState = 2),
                (t.lowStreamState = 2);
              var d = { appId: e.appId, sid: e.sessionId, cname: n, uid: o };
              p.report.sessionInit(e.sessionId, {
                ...
                (0, l.getGatewayList)(
                  d,
                  function(o) {
                    s.default.info('Joining channel: ' + n),
                      (t.key = i || e.appId),
                      (d.cid = o.cid),
                      (d.uid = o.uid),
                      (d.gatewayAddr = o.gateway_addr),
                      (t.joinInfo = d),
            ...
            (t.renewChannelKey = function(e, i, n) {
              void 0 === t.key
                ? (s.default.error('renewChannelKey should not be called before user join'),
                  (0, u.safeCall)(n, c.default.INVALID_OPERATION))
                : ((t.key = e),
                  (t.gatewayClient.key = e),
            ...
            (t._publish = function(i, n, o) {
              if (2 !== t.highStreamState)
                return (
                  s.default.warning("Can't publish stream when stream already publish", i.getId()),
                  o && o(c.default.STREAM_ALREADY_PUBLISHED)
                );
              s.default.info('Publishing stream, uid: ', i.getId()),
                (t.highStream = i),
                (t.highStreamState = 1),
                ...
                t.gatewayClient.publish(
                  ...
                  function() {
                    (i.sid = e.sessionId),
                      (t.highStreamState = 0),
                      s.default.info('Publish success, uid:', i.getId()),
                      t.isDualStream
                        ? t._publishLowStream(
                            function() {
                              n && n();
            ...
            (t._unpublish = function(e, i, n) {
              if (0 !== t.highStreamState)
                return (
                  s.default.warning("Can't unpublish stream when stream not publish"),
                  n && n(c.default.STREAM_NOT_YET_PUBLISHED)
                );
              s.default.info('Unpublish stream, uid: ', e.getId()),
                t.isDualStream && t.lowStream
                  ? (t._unpublishLowStream(null, n),
                    t.gatewayClient.unpublish(e, null, n),
                    (t.highStreamState = 2),
                    s.default.info('Unpublish stream success, uid:', e.getId()))
                  : (t.gatewayClient.unpublish(e, null, n),
                    (t.highStreamState = 2),
                    s.default.info('Unpublish stream success, uid:', e.getId())),
                i && i();
            ...
            (t.publish = function(e, i) {
              if (2 !== t.highStreamState) return void (i && i(c.default.STREAM_ALREADY_PUBLISHED));
              t._publish(e, null, i);
            }),
            (t.unpublish = function(e, i) {
              if (0 !== t.highStreamState) return void (i && i(c.default.STREAM_NOT_YET_PUBLISHED));
              t._unpublish(e, null, i);
            }),
            (t.subscribe = function(e, i) {
              s.default.info('Subscribe stream, uid: ', e.getId()),
                t.gatewayClient.subscribe(e, null, i);
            }),
            (t.unsubscribe = function(e, i) {
              s.default.info('Unsubscribe stream, uid: ', e.getId()),
            ...
            (t.setLiveTranscoding = function(e) {
              Object.assign(b, e), t.gatewayClient.setLiveTranscoding(b);
            }),
            (t.gatewayClient = (0, r.default)(e)),
                ...
                t._unpublish(
                  ...
                  function() {
                    t._publish(
                      ...
                      function() {
                        s.default.debug(
                          'Reconnect local peerConnection success:',
                          t.highStream.getId()
                        ),
                          t.gatewayClient.dispatchEvent({
                      ...
                      function(e) {
                        s.default.debug('Reconnect local peerConnection failed:' + e),
                          t.gatewayClient.dispatchEvent({
                            type: 'stream-reconnect-end',
                            id: t.highStream.getId(),
                          });
                ...
                t.gatewayClient.unsubscribe(
                  ...
                  function() {
                    t.gatewayClient.subscribe(
                      ...
                      function() {
                        s.default.debug(
                          'Reconnect remote peerConnection success:',
                          e.stream.getId()
                        ),
                          t.gatewayClient.dispatchEvent({
                            type: 'stream-reconnect-end',
                      ...
                      function(i) {
                        s.default.debug('Reconnect remote peerConnection failed:' + i),
                          t.gatewayClient.dispatchEvent({
                            type: 'stream-reconnect-end',
                            id: e.stream.getId(),
                          });
        ...
        E = { uid: 0, x: 0, y: 0, width: 0, height: 0, zOrder: 0, alpha: 1 },
        b = {
          width: 640,
          height: 360,
          videoBitrate: 400,
          videoFramerate: 15,
          lowLatency: !1,
          audioSampleRate: v.AUDIO_SAMPLE_RATE_48000,
          audioBitrate: 48,
          audioChannels: 1,
          videoGop: 30,
          videoCodecProfile: v.VIDEO_CODEC_PROFILE_HIGH,
          userCount: 0,
          userConfigExtraInfo: {},
          backgroundColor: 0,
          transcodingUsers: [],
        ...
        R = function(e) {
          return e && 'interop' === e.mode
            ? (s.default.info('Creating client , MODE : Interop'), h({ mode: 'live' }))
            : e && 'h264_interop' === e.mode
              ? (s.default.info('Creating client , MODE : h264_interop'),
                h({ mode: 'live', codec: 'h264' }))
              : (s.default.info('Creating client , MODE : web-only'), h({ mode: 'rtc' }));
        },
        I = function() {
          return (
            s.default.info('Creating client , MODE : rtc'),
            s.default.warning('createRtcClient is deprecated.'),
            h({ mode: 'rtc' })
          );
        },
        y = function(e) {
          var t = 'host';
          return (
            e && 'audience' === e.role && (t = e.role),
            s.default.info('Creating client , MODE : live'),
            s.default.warning('createLiveClient is deprecated.'),
            h({ mode: 'live', role: t })
          );
        };
      (t.createClient = R),
        (t.createRtcClient = I),
        (t.createLiveClient = y),
        (t.TranscodingUser = E),
        (t.LiveTranscoding = b);
    },
    function(e, t, i) {
      ...
      var o =
        ...
        b = function(e) {
          ...
          var i = !1,
            ...
            A = function(e, t, i) {
              return { _type: 'publish', options: e, sdp: t, p2pid: i };
            },
            C = function(e) {
            ...
            O = function(e, t, i) {
              return { _type: 'subscribe', options: e, sdp: t, p2pid: i };
            },
            w = function(e, t) {
          ...
          (M.p2pCounter = (0, h.random)(1e5)),
            ...
            (M.join = function(e, t, i, o) {
              ...
              return 0 !== M.state
                ...
                : null !== s && void 0 !== s && parseInt(s) !== s
                  ? (l.default.error('Input uid is invalid'),
                    o && o(f.default.INVALID_PARAMETER),
                    void S.report.joinGateway(e.sid, {
                      lts: r,
                      succ: !1,
                  ...
                  : ((M.joinInfo = e),
                    ...
                    void U(
                      e,
                      function(t) {
                        (M.stunServerUrl = t.stunServerUrl),
                          (M.turnServer = t.turnServer),
                          (M.state = 2),
            ...
            (M.leave = function(e, i) {
              if (2 != M.state) return void k(e);
              ...
              B(
                ...
                function(t) {
                  M.socket.close(),
                    (M.socket = void 0),
                    l.default.info('Leave channal success'),
                    e && e(t);
                },
                i
              );
            ...
            (M.publish = function(e, t, i) {
              var n = new Date().getTime();
              if (
                ((e.publishLTS = n), 'object' !== (void 0 === e ? 'undefined' : o(e)) || null === e)
              )
                return (
                  l.default.error('Invalid local stream'),
                  i && i(f.default.INVALID_LOCAL_STREAM),
                  void S.report.publish(M.joinInfo.sid, {
                    lts: n,
                    succ: !1,
              ...
              if (null === e.stream && void 0 === e.url)
                return (
                  l.default.error('Invalid local media stream'),
                  i && i(f.default.INVALID_LOCAL_STREAM),
                  void S.report.publish(M.joinInfo.sid, {
                    lts: n,
                    succ: !1,
              ...
              if (2 !== M.state)
                return (
                  ...
                  i && i(f.default.INVALID_OPERATION),
                  void S.report.publish(M.joinInfo.sid, {
                    lts: n,
                    succ: !1,
                    ec: f.default.INVALID_OPERATION,
              ...
              if (
                e.local &&
                void 0 === M.localStreams[e.getId()] &&
                (e.hasAudio() || e.hasVideo() || e.hasScreen())
              ) {
                ...
                void 0 !== e.url
                  ...
                  : ((M.localStreams[e.getId()] = e),
                    (e.pc = (0, d.Connection)({
                      callback: function(o) {
                        l.default.debug('SDP exchange in publish : send offer --  ', JSON.parse(o)),
                          x(
                            A(
                              {
                                state: 'offer',
                            ...
                            function(r, s) {
                              if ('error' === r)
                                return (
                                  ...
                                  i && i(f.default.PUBLISH_STREAM_FAILED),
                                  void S.report.publish(M.joinInfo.sid, {
                                    lts: n,
                                    succ: !1,
                                    localSDP: o,
                              ...
                              (e.pc.onsignalingmessage = function(t) {
                                (e.pc.onsignalingmessage = function() {}),
                                  ...
                                  (e.unmuteAudio = function() {
                                    B(
                                      m({ action: 'audio-out-on', streamId: e.getId() }),
                                      function() {},
                                      function() {}
                                    );
                                  }),
                                  (e.unmuteVideo = function() {
                                    B(
                                      m({ action: 'video-out-on', streamId: e.getId() }),
                                      function() {},
                                      function() {}
                                    );
                                  }),
                                  (e.muteAudio = function() {
                                    B(
                                      m({ action: 'audio-out-off', streamId: e.getId() }),
                                      function() {},
                                      function() {}
                                    );
                                  }),
                                  (e.muteVideo = function() {
                                    B(
                                      m({ action: 'video-out-off', streamId: e.getId() }),
                                      function() {},
                                      function() {}
                                    );
                                  }),
                                  e.getId() === e.getUserId() &&
                                    (e.isAudioOn() ||
                                      (e.hasAudio() &&
                                        (l.default.debug('local stream audio mute'),
                                        e.muteAudio())),
                                    e.isVideoOn() ||
                                      ((e.hasVideo() || e.hasScreen()) &&
                                        (l.default.debug('local stream video mute'),
                                        e.muteVideo())));
                              }),
                                (e.pc.oniceconnectionstatechange = function(o) {
                                  'failed' === o
                                    ? (void 0 != M.timers[e.getId()] &&
                                        clearInterval(M.timers[e.getId()]),
                                      l.default.error('Publisher connection is lost'),
                                      i && i(f.default.PEERCONNECTION_FAILED),
                                      M.p2ps.delete(a),
                                      M.dispatchEvent(
                                        (0, c.ClientEvent)({ type: 'pubP2PLost', stream: e })
                                      ),
                                ...
                                l.default.debug(
                                  'SDP exchange in publish : receive answer --  ',
                                  JSON.parse(r)
                                ),
                                e.pc.processSignalingMessage(r);
                            }
                          );
                      },
                      audio: e.hasAudio(),
                      ...
                      e &&
                        ...
                        e.pc.getStatsRate(function(t) {
                          t.forEach(function(t) {
                            (-1 === t.id.indexOf('outbound_rtp') &&
                              -1 === t.id.indexOf('OutboundRTP')) ||
                              'video' !== t.mediaType ||
                              ((t.googFrameWidthSent = e.videoWidth + ''),
                              (t.googFrameHeightSent = e.videoHeight + '')),
                              e.getUserId &&
                                (e.getId() === e.getUserId()
                                  ? B(C(t), null, null)
                                  : B(T(t), null, null));
                    ...
                    void 0 !== e.aux_stream &&
                      (e.pc.addStream(e.aux_stream),
                      l.default.debug('PeerConnection add stream :', e.aux_stream)));
              }
            }),
            (M.unpublish = function(e, t, i) {
              return 'object' !== (void 0 === e ? 'undefined' : o(e)) || null === e
                ? (l.default.error('Invalid local stream'),
                  void k(i, f.default.INVALID_LOCAL_STREAM))
                : 2 !== M.state
                  ? (l.default.error('User not in the session'),
                    void k(i, f.default.INVALID_OPERATION))
                    ...
                    void (void 0 !== M.socket
                      ? e.local && void 0 !== M.localStreams[e.getId()]
                        ? (delete M.localStreams[e.getId()],
                          ...
                          t && t())
                        : (l.default.error('Invalid local stream'),
                          k(i, f.default.INVALID_LOCAL_STREAM))
                      : (l.default.error('User not in the session'),
                        k(i, f.default.INVALID_OPERATION))));
            }),
            (M.subscribe = function(e, t, i) {
              ...
              if (
                ...
                return (
                  ...
                  i && i(f.default.INVALID_REMOTE_STREAM),
                  void S.report.subscribe(M.joinInfo.sid, {
                    lts: n,
                    succ: !1,
                    peerid: e.getId() + '',
              ...
              if (!e.local && M.remoteStreams.hasOwnProperty(e.getId()))
                  ...
                  (e.pc = (0, d.Connection)({
                        ...
                        x(
                          ...
                          function(t) {
                            if ('error' === t)
                              return (
                                l.default.error(
                                  'Subscribe remote stream failed, closing stream ',
                                  e.getId()
                                ),
                                e.close(),
                                i && i(f.default.SUBSCRIBE_STREAM_FAILED),
                                void S.report.subscribe(M.joinInfo.sid, {
                                  lts: n,
                                  succ: !1,
                                  peerid: e.getId() + '',
                            ...
                            l.default.debug(
                              'SDP exchange in subscribe : receive answer --  ',
                              JSON.parse(t)
                            ),
                    ...
                    (e.pc.onaddstream = function(t, i) {
                      if (('ontrack' === i && 'video' === t.track.kind) || 'onaddstream' === i) {
                        if (
                          ...
                          (M.remoteStreams[e.getId()].stream =
                            'onaddstream' === i ? t.stream : t.streams[0]),
                      ...
                      (e.unmuteAudio = function() {
                        B(
                          m({ action: 'audio-in-on', streamId: e.getId() }),
                          function() {},
                          function() {}
                        );
                      }),
                        (e.muteAudio = function() {
                          B(
                            m({ action: 'audio-in-off', streamId: e.getId() }),
                            function() {},
                            function() {}
                          );
                        }),
                        (e.unmuteVideo = function() {
                          B(
                            m({ action: 'video-in-on', streamId: e.getId() }),
                            function() {},
                            function() {}
                          );
                        }),
                        (e.muteVideo = function() {
                          B(
                            m({ action: 'video-in-off', streamId: e.getId() }),
                            function() {},
                            function() {}
                          );
                        });
                    ...
                    (M.timers[e.getId()] = setInterval(function() {
                      e &&
                        ...
                        e.pc.getStatsRate(function(t) {
                          t.forEach(function(t) {
                            -1 !== t.id.indexOf('inbound_rtp') &&
                              'video' === t.mediaType &&
                              ((t.googFrameWidthReceived = e.videoWidth + ''),
                              (t.googFrameHeightReceived = e.videoHeight + '')),
                              x(w(e.getId(), t), null, null);
                          });
                        });
                    }, 3e3)),
                        ...
                        e.pc.getStats(function(t) {
                          t.forEach(function(t) {
                            if ('audio' === t.mediaType) {
                              ...
                              var n = Object.keys(M.audioLevel),
                              ...
                              if (M.activeSpeaker !== o[0]) {
                                ...
                                M.dispatchEvent(r),
                                  (M.activeSpeaker = o[0]),
                                  l.default.debug('Update active speaker:' + M.activeSpeaker);
                              }
                            }
                          });
                        });
                    ...
                    (e.pc.oniceconnectionstatechange = function(o) {
                      'failed' === o
                        ? (void 0 != M.timers[e.getId()] &&
                            (clearInterval(M.timers[e.getId()]),
                            clearInterval(M.timers[e.getId()] + 'audio')),
                          M.p2ps.delete(r),
                          l.default.error('Subscriber connection is lost', e.getId()),
                          i && i(f.default.PEERCONNECTION_FAILED),
                          M.remoteStreams[e.getId()] &&
                            M.dispatchEvent((0, c.ClientEvent)({ type: 'subP2PLost', stream: e })),
                ...
                l.default.error('No such remote stream'),
                  i && i(f.default.NO_SUCH_REMOTE_STREAM),
                  S.report.subscribe(M.joinInfo.sid, {
                    lts: n,
                    succ: !1,
                    peerid: e.getId() + '',
            ...
            (M.unsubscribe = function(e, t, i) {
              return 'object' !== (void 0 === e ? 'undefined' : o(e)) || null === e
                ? (l.default.error('Invalid remote stream'),
                  void k(i, f.default.INVALID_REMOTE_STREAM))
                : 2 !== M.state
                  ? (l.default.error('User is not in the session'),
                    void k(i, f.default.INVALID_OPERATION))
                  : (void 0 != M.timers[e.getId()] &&
                    ...
                    M.remoteStreams.hasOwnProperty(e.getId())
                      ? M.socket
                          ...
                          : (e.close(),
                            void B(
                              ...
                              function(n) {
                                if ('error' === n)
                                  return (
                                    l.default.error('Unsubscribe remote stream failed', e.getId()),
                                    void k(i, f.default.UNSUBSCRIBE_STREAM_FAILED)
                                  );
                        ...
                        : (l.default.error('User is not in the session'),
                          void k(i, f.default.INVALID_OPERATION))
                      : void k(i, f.default.NO_SUCH_REMOTE_STREAM));
            }),
            (M.setRemoteVideoStreamType = function(e, t) {
              if (
                (l.default.debug('Switching remote video stream ' + e.getId() + ' to ' + t),
                'object' !== (void 0 === e ? 'undefined' : o(e)) || null === e)
              )
            ...
            (M.startLiveStreaming = function(e, t) {
              if (
                (M.liveStreams.set(e, t),
                l.default.debug('Start live streaming ' + e + ' transcodingEnabled ' + t),
                2 !== M.state)
              )
            ...
            (M.stopLiveStreaming = function(e) {
              if ((l.default.debug('Stop live streaming ' + e), 2 !== M.state))
                return void l.default.error('User is not in the session');
              M.liveStreams.delete(e), B(D(e), null, null);
            }),
            (M.setLiveTranscoding = function(e) {
              if ((0, h.isLiveTranscodingValid)(e)) {
                if (
                  ((M.transcoding = e), l.default.debug('Set live transcoding ', e), 2 !== M.state)
                )
                  return void l.default.error('User is not in the session');
                B(L(e), null, null);
              }
          ...
          M.rejoin = function() {
            0 !== M.state && (M.state = 0),
              M.socket && (clearInterval(M.pingTimer), M.socket.close(), (M.socket = void 0)),
              V();
          };
          var V = function() {
              M.key
                ? (l.default.info('Re-joining to channel ' + M.joinInfo.cname),
                  M.join(
                    M.joinInfo,
                    M.key,
                    function(e) {
                      l.default.info('User ' + e + ' is re-joined to ' + M.joinInfo.cname);
                      for (var t in M.localStreams)
                        if (void 0 !== M.localStreams[t]) {
                          var i = M.localStreams[t];
                          delete M.localStreams[t],
                    ...
                    function(e) {
                      l.default.error('Re-join to channel failed [' + e + ']'),
                        M.dispatchEvent((0, c.StreamEvent)({ type: 'error', reason: e }));
                    }
                  ))
              ...
              void 0 !== M.socket
                ...
                : (F(e.gatewayAddr),
                  ...
                  M.socket.on('connect', function() {
                    (M.attemps = 1), B(b(e), n, o);
                  }),
                  M.socket.on('reconnect', function() {
                    l.default.debug('Try to reconnect choose server and get gateway list again '),
                      (0, v.getGatewayList)(M.joinInfo, function(e) {
                        M.socket.reconnect(e.gateway_addr);
                      });
                  }),
                  M.socket.on('connect_error', function(e) {
                  ...
                  M.socket.on('onAddAudioStream', function(e) {
                    if (
                      (l.default.info('Newly added audio stream with uid', e.id),
                      M.remoteStreamsInChannel.has(e.id) || M.remoteStreamsInChannel.add(e.id),
                      void 0 === M.remoteStreams[e.id])
                    ) {
                      var t = (0, r.Stream)({
                        streamID: e.id,
                        local: !1,
                  ...
                  M.socket.on('onAddVideoStream', function(e) {
                    if (
                      (l.default.info('Newly added remote stream with uid', e.id),
                      M.remoteStreamsInChannel.has(e.id) || M.remoteStreamsInChannel.add(e.id),
                      void 0 === M.remoteStreams[e.id])
                    ) {
                      var t = (0, r.Stream)({
                      ...
                      (M.remoteStreams[e.id].video = !0),
                        M.remoteStreams[e.id].enableVideo(),
                        l.default.info('Stream changed: enable video ' + e.id);
                      ...
                      (M.remoteStreams[e.id] = t),
                        l.default.info('Stream changed: modify video ' + e.id);
                    }
                  }),
                  M.socket.on('onRemoveStream', function(e) {
                    ...
                    if (!t)
                      return void console.log(
                        'ERROR stream ',
                        e.id,
                        ' not found onRemoveStream ',
                        e
                      );
                    delete M.remoteStreams[e.id];
                    var i = (0, c.StreamEvent)({ type: 'stream-removed', stream: t });
                    M.dispatchEvent(i),
                      t.close(),
                      void 0 !== t.pc && (t.pc.close(), (t.pc = void 0));
                  }),
                  M.socket.on('onPublishStream', function(e) {
                    var t = M.localStreams[e.id],
                      i = (0, c.StreamEvent)({ type: 'stream-published', stream: t });
                    M.dispatchEvent(i);
                  }),
                  M.socket.on('mute_audio', function(e) {
                    if (M.remoteStreamsInChannel.has(e.peerid)) {
                  ...
                  M.socket.on('onP2PLost', function(e) {
                    ...
                    n &&
                      (M.p2ps.delete(e.p2pid),
                      n.local
                        ? M.dispatchEvent((0, c.ClientEvent)({ type: 'pubP2PLost', stream: n }))
                        : M.remoteStreams[n.getId()] &&
                          M.dispatchEvent((0, c.ClientEvent)({ type: 'subP2PLost', stream: n })));
                  }),
                  M.socket.on('onRepeatJoin', function(e) {
                    console.log('recv onRepeatJoin message: uid=' + e.uid);
                  }),
                  M.socket.on('onPeerLeave', function(e) {
                    ...
                    M.timers.hasOwnProperty(e.id) &&
                      (clearInterval(M.timers[e.id]), delete M.timers[e.id]),
            ...
            B = function(e, t, i) {
              if (void 0 === M.socket)
                return (
                  l.default.error('No socket available'), void k(i, f.default.INVALID_OPERATION)
                );
              try {
                M.socket.emitSimpleMessage(e, function(e, n) {
                  'success' === e
                    ? 'function' == typeof t && t(n)
                    : 'function' == typeof i && i(p.GatewayErrorCode[n] || n);
                });
              } catch (t) {
                l.default.error('Socket emit message failed' + JSON.stringify(e)),
                  l.default.error(t),
                  k(i, f.default.SOCKET_ERROR);
              }
            },
            x = function(e, t) {
              if (void 0 === M.socket)
                return void l.default.error('Error in sendSimpleSdp [socket not ready]');
              try {
      ...
      var n = i(31),
        ...
        a = function(e, t) {
          ...
          return (
            (i.connect = function() {
              (t.host = e),
                (i.signal = (0, o.default)(t)),
                (i.on = i.signal.on),
                (i.dispatchEvent = i.signal.dispatchEvent),
                i.signal.on('onopen', function(e) {
                  (i.signal.onEvent = function(e) {
                    i.dispatchEvent((0, r.MediaEvent)({ type: e.event, msg: e }));
                  }),
                    i.dispatchEvent((0, r.MediaEvent)({ type: 'connect', msg: e }));
                }),
        ...
        u = function(e) {
          ...
          return (
            ...
            (t.creatConnection = function() {
              if (t.hostIndex >= t.host.length)
                return (
                  (t.hostIndex = 0), void t.dispatchEvent((0, o.MediaEvent)({ type: 'reconnect' }))
                );
              d.default.debug('start connect:' + t.host[t.hostIndex]),
                ...
                (t.connection.onopen = function(e) {
                  d.default.debug('websockect opened'),
                    ...
                    t.dispatchEvent((0, o.MediaEvent)({ type: 'onopen', event: e, socket: t }));
                }),
                (t.connection.onmessage = function(e) {
                  var i = JSON.parse(e.data);
                  i.hasOwnProperty('_id')
                    ? t.dispatchEvent((0, o.MediaEvent)({ type: i._id, msg: i }))
                    : i.hasOwnProperty('_type') &&
                      t.dispatchSocketEvent((0, o.MediaEvent)({ type: i._type, msg: i.message }));
                }),
                (t.connection.onclose = function(i) {
                  t.needReconnect
                    ? t.isTimeout || t.isInit
                      ? (d.default.debug('websockect connect timeout'),
                        c.report.joinGateway(e.sid, {
                          lts: t.lts,
                          succ: !1,
                          ec: 'timeout',
                        ...
                        t.creatConnection())
                      : t.dispatchEvent((0, o.MediaEvent)({ type: 'disconnect', event: i }))
                    : (d.default.debug('websockect closeed'),
                      (0, a.default)(e.onFailure, i),
                      clearTimeout(t.timeoutCheck),
                      t.dispatchEvent((0, o.MediaEvent)({ type: 'close', event: i })),
              ...
              setTimeout(function() {
                t.connection &&
                  t.connection.readyState != WebSocket.OPEN &&
                  ((t.isTimeout = !0), t.connection.close());
              }, 5e3);
            }),
            t.creatConnection(),
            (t.sendMessage = function(e, i) {
              t.connection && t.connection.readyState == WebSocket.OPEN
                ? t.connection.send(JSON.stringify(e))
                : i({ error: 'Gateway not connected' });
            }),
            ...
            (t.sendSignalCommand = function(e, i) {
              (e._id = '_request_' + t.requestID),
                (t.requestID += 1),
                'publish_stats' !== e._type &&
                  'subscribe_stats' !== e._type &&
                  'publish_stats_low' !== e._type &&
                  t.on(e._id, function(n) {
    ...
    function(e, t, i) {
      ...
      var n = i(3),
        o = function(e) {
          ...
          return (0, n.isFireFox)()
            ? [t[1], 15, 100]
            : (0, n.isSafari)() ? [t[2], 15, 50] : [t[0], 15, 50];
        };
      t.simMap = o;
    },
    ,
